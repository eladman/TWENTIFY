...
const exerciseArray: Exercise[] = [
  ...
  // ── Isolation & muscle-build accessories (11) ─────────────────────
  ...
  e({
    ...
    secondaryMuscles: [],
    equipment: 'dumbbell',
    alternatives: ['face_pull', 'db_shoulder_press'],
    citationIds: ['schoenfeld_2017_volume', 'schoenfeld_2017_load', 'kraemer_2004', 'schoenfeld_2016_frequency'],
    instructions:
      'Stand with a dumbbell in each hand at your sides. Raise both arms out to the sides until they are parallel with the floor, then lower under control.',
    cues: ['Lead with your elbows', 'Slight bend in the elbows throughout', 'Control the descent — no swinging'],
  ...
  e({
    ...
    secondaryMuscles: [],
    equipment: 'dumbbell',
    alternatives: ['hammer_curl', 'bw_pullup'],
    citationIds: ['schoenfeld_2017_volume', 'schoenfeld_2017_load', 'kraemer_2004', 'schoenfeld_2016_frequency'],
    instructions:
      'Stand holding a dumbbell in each hand with palms facing forward. Curl the weights up toward your shoulders, squeeze at the top, then lower under control.',
    cues: ['Keep elbows pinned to your sides', 'Full extension at the bottom', 'No swinging — use controlled tempo'],
  ...
  e({
    ...
    secondaryMuscles: [],
    equipment: 'cable',
    alternatives: ['tricep_extension', 'bw_dip'],
    citationIds: ['schoenfeld_2017_volume', 'schoenfeld_2017_load', 'kraemer_2004', 'schoenfeld_2016_frequency'],
    instructions:
      'Stand at a cable machine with a straight or rope attachment. Push the handle down until your arms are fully extended, then return under control.',
    cues: ['Elbows stay tight to your body', 'Squeeze triceps at full extension', 'Slow eccentric — 2 seconds up'],
    defaultReps: { min: 10, max: 15 },
    defaultSets: 2,
    restSeconds: 60,
  }),
  ...
  e({
    ...
    secondaryMuscles: [],
    equipment: 'dumbbell',
    alternatives: ['tricep_pushdown', 'bw_dip'],
    citationIds: ['schoenfeld_2017_volume', 'schoenfeld_2017_load', 'kraemer_2004', 'schoenfeld_2016_frequency'],
    instructions:
      'Hold a dumbbell overhead with both hands. Lower it behind your head by bending at the elbows, then extend back to the starting position.',
    cues: ['Keep upper arms vertical', 'Full stretch at the bottom', 'Elbows point forward, not out'],
    defaultReps: { min: 10, max: 15 },
    defaultSets: 2,
    restSeconds: 60,
  }),
  ...
  e({
    ...
    equipment: 'cable',
    alternatives: ['lateral_raise', 'bw_inverted_row'],
    citationIds: ['schoenfeld_2017_volume', 'schoenfeld_2017_load', 'kraemer_2004', 'schoenfeld_2016_frequency'],
    instructions:
      'Set a cable at face height with a rope attachment. Pull toward your face, separating the rope ends as you pull, squeezing your rear delts at the peak.',
    cues: ['Pull to your ears, not your chin', 'Externally rotate at the peak', 'Keep elbows high throughout'],
    defaultReps: { min: 12, max: 15 },
    defaultSets: 2,
    restSeconds: 60,
  }),
  ...
  e({
    ...
    secondaryMuscles: [],
    equipment: 'machine',
    alternatives: ['bw_glute_bridge', 'romanian_deadlift'],
    citationIds: ['schoenfeld_2017_volume', 'schoenfeld_2017_load', 'kraemer_2004', 'schoenfeld_2016_frequency'],
    instructions:
      'Lie face-down on the leg curl machine with the pad against your lower calves. Curl your heels toward your glutes, pause briefly, then lower under control.',
    cues: ['Hips stay flat on the pad', 'Squeeze hamstrings at the top', 'Slow negative — 2-3 seconds down'],
    defaultReps: { min: 10, max: 15 },
    defaultSets: 3,
    restSeconds: 60,
  }),
  ...
  e({
    ...
    secondaryMuscles: [],
    equipment: 'machine',
    alternatives: ['bw_squat', 'db_goblet_squat'],
    citationIds: ['schoenfeld_2017_volume', 'schoenfeld_2017_load', 'kraemer_2004', 'schoenfeld_2016_frequency'],
    instructions:
      'Sit in the leg extension machine with the pad on your lower shins. Extend your legs until straight, squeeze your quads at the top, then lower under control.',
    cues: ['Sit back firmly against the pad', 'Full lockout at the top', 'Control the descent — no dropping'],
    defaultReps: { min: 10, max: 15 },
    defaultSets: 3,
    restSeconds: 60,
  }),
  ...
  e({
    ...
    equipment: 'dumbbell',
    alternatives: ['bench_press', 'db_bench_press', 'bw_pushup'],
    citationIds: ['gentil_2013', 'schoenfeld_2017_volume', 'schoenfeld_2017_load', 'kraemer_2004', 'schoenfeld_2024_rest', 'schoenfeld_2016_frequency'],
    instructions:
      'Set a bench to 30-45 degrees. Press dumbbells from shoulder height to full extension overhead, then lower under control to the starting position.',
    cues: ['Retract your shoulder blades', 'Lower until upper arms are parallel to the floor', 'Press the dumbbells together at the top'],
    defaultReps: { min: 8, max: 12 },
    defaultSets: 3,
    restSeconds: 90,
  }),
  ...
  e({
    ...
    equipment: 'cable',
    alternatives: ['barbell_row', 'db_row', 'bw_inverted_row'],
    citationIds: ['gentil_2013', 'schoenfeld_2017_volume', 'schoenfeld_2017_load', 'kraemer_2004', 'schoenfeld_2024_rest', 'schoenfeld_2016_frequency'],
    instructions:
      'Sit at a cable row station with feet braced. Pull the handle to your lower chest, squeezing your shoulder blades together, then extend your arms fully.',
    cues: ['Chest stays tall — no rounding', 'Squeeze shoulder blades at peak contraction', 'Full stretch on the return'],
    defaultReps: { min: 8, max: 12 },
    defaultSets: 3,
    restSeconds: 90,
  }),
  ...
  e({
    ...
    secondaryMuscles: [],
    equipment: 'dumbbell',
    alternatives: ['bicep_curl', 'bw_pullup'],
    citationIds: ['schoenfeld_2017_volume', 'schoenfeld_2017_load', 'kraemer_2004', 'schoenfeld_2016_frequency'],
    instructions:
      'Stand holding dumbbells with palms facing each other (neutral grip). Curl the weights up toward your shoulders, then lower under control.',
    cues: ['Keep palms facing each other throughout', 'Elbows stay pinned to your sides', 'No swinging — controlled tempo'],
    defaultReps: { min: 10, max: 15 },
    defaultSets: 2,
    restSeconds: 60,
  }),
  ...
  e({
    ...
    secondaryMuscles: ['hamstrings', 'core'],
    equipment: 'dumbbell',
    alternatives: ['barbell_squat', 'db_goblet_squat', 'db_lunges', 'bw_squat'],
    citationIds: ['gentil_2013', 'schoenfeld_2017_volume', 'schoenfeld_2017_load', 'kraemer_2004', 'schoenfeld_2024_rest', 'schoenfeld_2016_frequency'],
    instructions:
      'Stand a stride-length in front of a bench. Place the top of your rear foot on the bench. Hold dumbbells at your sides and squat down until your front thigh is parallel to the floor, then drive up.',
    cues: ['Front shin stays roughly vertical', 'Upright torso — don\u2019t lean forward', 'Push through the front heel'],
    defaultReps: { min: 8, max: 12 },
    defaultSets: 3,
    restSeconds: 90,
  }),
