...
export const muscleBuildTemplate: NutritionTemplate = {
  ...
  rules: [
    {
      id: 'mb_protein',
      rule: 'Hit 1.6-2.2g protein per kg per day across 3-5 meals',
      why: 'Distributing adequate protein across meals maximises muscle protein synthesis throughout the day.',
      citationId: 'morton_2018',
      priority: 1,
    },
    {
      id: 'mb_surplus',
      rule: 'Eat at a slight surplus: 300-500 calories above maintenance',
      why: 'A modest caloric surplus provides energy for muscle growth without excessive fat gain.',
      citationId: 'helms_pyramid',
      priority: 2,
    },
    {
      id: 'mb_timing',
      rule: 'Total daily protein matters most. Timing is secondary.',
      why: 'Research shows total daily intake is the primary driver of muscle growth — meal timing has a much smaller effect.',
      citationId: 'morton_2018',
      priority: 3,
    },
    {
      id: 'mb_whole_foods',
      rule: "Eat mostly whole foods — but don't stress about perfection",
      why: 'Whole foods provide better micronutrient density and satiety, but rigid dieting reduces long-term adherence.',
      citationId: 'helms_pyramid',
      priority: 4,
    },
    {
      id: 'mb_sleep',
      rule: 'Sleep 7-9 hours — muscles grow during recovery, not training',
